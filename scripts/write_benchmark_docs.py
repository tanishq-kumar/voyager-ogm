"""Generates benchmarks/README.md with comprehensive documentation and SVG charts."""

from pathlib import Path

CONTENT = """# Voyager OGM — Benchmark Suite & Reproducibility Guide
...
def main():
    target = Path("benchmarks/README.md")
