...
class Session:
    ...
    def __init__(
        ...
        Args:
            ...
            enable_identity_map: Opt-in flag to enable the hybrid Active Record & Data Mapper
...
class AsyncSession:
    ...
    @property
    def identity_map_enabled(self) -> bool:
        """Whether the Identity Map is enabled for this async session."""
        return self._enable_identity_map

    def register(self, node: Any, key_field: str = "id", is_clean: bool = False) -> Any:
        """Registers a node instance with this async session's Identity Map.
